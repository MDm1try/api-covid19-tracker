...
const sendsendNotifications = async () => {
    const customersInInfectedPlaces = await findСustomersInInfectedPlaces()
    const customersContactedByInfected = await findCustomersContactedByInfected()
    ...
    //         message: `You have visited "${locationName}" place ${customer.hoursAfter} hour(s) ago where people got infected with COVID-19.`,
